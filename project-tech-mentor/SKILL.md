...
- **Create or revise a domain route:** read [track card](references/track-card.md) and [track format](references/TRACK-FORMAT.md). Base claims and version-sensitive choices on current primary sources; record the source, version, and why it matters in `RESOURCES.md`.
